...
class SiteClaimConfiguration(SingletonModel):
    ...
    site_claim_output_channel = models.BigIntegerField(null=True, blank=True, default=None)
...
class Site(models.Model):
    ...
    found_by_discord_uid = models.BigIntegerField(null=True, default=None, blank=True, )
    ...
    claimed_by_discord = models.CharField(max_length=200, default="", blank=True)
    claimed_by_discord_uid = models.BigIntegerField(null=True, default=None, blank=True, )
    ...
    run_by_notified_by_discord_uid = models.BigIntegerField(null=True, default=None, blank=True, )
    ...
    system = models.ForeignKey(System, null=True, default=None, blank=True, on_delete=models.SET_NULL, )
